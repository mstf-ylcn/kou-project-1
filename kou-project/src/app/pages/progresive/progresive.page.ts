...
import { IonItem, IonItemSliding, IonList } from '@ionic/angular';
...
@Component({
  selector: 'app-progresive',
  templateUrl: './progresive.page.html',
  styleUrls: ['./progresive.page.scss'],
})
export class ProgresivePage implements OnInit {
  constructor(
